...
public class UserReviewController {
    ...
    public List<UserReview> getReviews() throws SQLException {

        return reviewDatabase.getAllReviews();

    }

    @GetMapping("/review/get/{location}")
    public List<UserReview> getReviewByLocation(@PathVariable String location) throws SQLException {
        return reviewDatabase.getReviewsByLocation(location);
    }
}
